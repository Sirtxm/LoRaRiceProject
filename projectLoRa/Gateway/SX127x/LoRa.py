...
class LoRa(object):
    ...
    def __init__(self, verbose=True, do_calibration=False, calibration_freq=923.0):
        """ Init the object
    ...
    def clear_payload(self):
        """Clears the payload buffer."""
        self.spi.xfer([REG.LORA.FIFO_ADDR_PTR | 0x80, REG.LORA.FIFO])
        self.spi.xfer([REG.LORA.FIFO_ADDR_PTR, 0])
        self.spi.xfer([REG.LORA.FIFO_ADDR_PTR | 0x80, REG.LORA.FIFO])
    ...
    def write_payload(self, payload):
        ...
        return self.spi.xfer([REG.LORA.FIFO | 0x80] + list(payload.encode()))[1:]
    ...
    def rx_chain_calibration(self, freq=923.0):
